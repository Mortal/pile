...
%
%   \pil{\datit}{Matematisk kantine}{\scalebox{2}{Hej}}
% bliver til...
%   \newcommand{\datit}[1]{
%     \skilt
...
%     {\scalebox{2}{Hej}}}
%
% Og så kan man skrive f.eks. \datit{\venstre} som bliver til
%   \skilt
%   {\includegraphics[angle=\venstre,origin=c]{pil.pdf}}
%   {\scalebox{5.60}[16]{Matematisk kantine}}
%   {\scalebox{2}{Hej}}}
%
% Hvis man skal bruge flere ens pile, skriver man f.eks.
%   \Repeat{4}{\datit{\ned}}
% som bliver til
%   \datit{\ned}\datit{\ned}\datit{\ned}\datit{\ned}
...
% \pil{\command}{navn}{tekst}{\<retning>}
\def\pil#1#2#3{%
  \newcommand{#1}[1]{%
    \skilt{%
      \includegraphics[angle=##1,origin=c]{pil.pdf}%
